...
export class Svg extends Component {
  constructor(props) {
    ...
    this.showNeighbours = this.showNeighbours.bind(this)
    ...
    this.calculated = this.props.data
          .map((d,i) => this.calculate(d))
  }
  ...
  showNeighbours(i) {
    ...
    else if (Array.isArray(this.state.neighbours) && this.state.neighbours.includes(i)) {
      return "neighbour"
    }
    return "default"
  }
